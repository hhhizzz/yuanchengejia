...
import com.xunix.ycej.utils.ImageProcessing;
import com.xunix.ycej.utils.XinlvObject;
...
public class HeartActivity extends Activity {
    ...
    private static WakeLock wakeLock = null;//保持屏幕常亮
    private static int averageIndex = 0;
    private static final int averageArraySize = 4;
    private static final int[] averageArray = new int[averageArraySize];
    private static TextView tv_result = null;
    private static TextView tv_message = null;
    /**
     * 类型枚举
     */
    ...
    //创建心率对象
    public static void creatObject(int temp) throws AVException {
