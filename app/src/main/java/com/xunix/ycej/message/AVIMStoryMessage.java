...
public class AVIMStoryMessage extends AVIMTypedMessage {
    ...
    public AVIMStoryMessage() {
    }

    public AVIMStoryMessage(String localPath) throws IOException {
        this(new File(localPath));
    }

    public AVIMStoryMessage(File localFile) throws IOException {
    ...
    public AVIMStoryMessage(AVFile file) {
            ...
            this.actualFile.saveInBackground(new SaveCallback() {
                public void done(AVException e) {
                    if(e != null) {
                        ...
                        AVIMStoryMessage.this.fulFillFileInfo(callback);
                    }
        ...
        if(this.actualFile != null) {
            ...
            if(null != this.actualFile.getMetaData() && this.actualFile.getMetaData().containsKey("__source") && this.actualFile.getMetaData().get("__source").equals("external")) {
                ...
                this.getAdditionalMetaData((Map)metaData, new SaveCallback() {
                    public void done(AVException e) {
                        AVIMStoryMessage.this.file.put("metaData", metaData);
                        if(callback != null) {
                            callback.internalDone(e);
                        }
