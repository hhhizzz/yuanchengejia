...
public class FriendAdapterOld extends RecyclerView.Adapter<FriendAdapterOld.MyViewHolder> {
    ...
    public FriendAdapterOld(Context context, List<AVUser> users) {
        mContext = context;
        this.users = users;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = mLayoutInflater.inflate(R.layout.card_friend_old, parent, false);
